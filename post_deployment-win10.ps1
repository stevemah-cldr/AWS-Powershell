# Post Deployment script for Windows 10
...
#join DomainName
Add-Computer -DomainName $domain -Credential $credential -ComputerName $currenthostname -NewName $NewComputerName -OUPath "OU=Windows10,OU=endpoints_ou,DC=ansa,DC=aws" -Restart |Tee-Object -Append -FilePath $logfile
