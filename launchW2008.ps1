# Script to Create Windows SRV 2008R2 instances from our custom ami

# Declare Instance Variables
# ImageID template last update using: Winsrv2012
$ImageId = "ami-0559a17a715ca89c2"
...
$UserDataTemplate = 'C:\autonomic_workarea\autonomic-software_producteng\AWS\powershell\deployment_scripts\post_deployment-win2008.ps1'
