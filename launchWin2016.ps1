# Script to Create Windows Server 2016 instances from our custom ami

# Declare Instance Variables
$ImageId = "ami-0e57f270405b2d14e"
...
$UserDataTemplate = 'C:\autonomic_workarea\autonomic-software_producteng\AWS\powershell\deployment_scripts\post_deployment-win2016.ps1'
...
Write-Host "For windows 2016, you will need to manually add this to the ansa.aws domain"
Write-Host "The default Administrator Password is Tylercat20"
