# Script to Create Windows 8.1 instances from our custom ami

# Declare Instance Variables
# ImageID template last update using: Win8
$ImageId = "ami-0a524b4f2b0f8cce7"
...
$UserDataTemplate = 'C:\autonomic_workarea\autonomic-software_producteng\AWS\powershell\deployment_scripts\post_deployment-win81.ps1'
