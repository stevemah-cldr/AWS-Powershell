# Post Deployment script for Windows SRV 2008R2
...
#join DomainName
Add-Computer -DomainName $domain -Credential $credential -ComputerName $currenthostname -NewName $NewComputerName -OUPath "OU=Windowssrv2008,OU=endpoints_ou,DC=ansa,DC=aws" -Restart |Tee-Object -Append -FilePath $logfile
